    ...
    <jet-form-section @submitted="updatePassword">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="رمز عبور فعلی" />
