<x-jet-action-section>
    ...
    <x-slot name="description">
         مدیریت و خروج از Session های فعال از دیگر مرورگر و دستگاه ها
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            در صورت نیاز میتوانید از تمام مرورگر ها در تمام دستگاه ها خارج شوید. اگر فکر میکنید حساب کاربری شما به سرقت رفته است باید رمز عبور خود را نیز تغییر دهید.
        </div>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="text-green-500 font-semibold">این دستگاه</span>
                                    @else
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                ...
                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <x-jet-input type="password" class="mt-1 block w-3/4" placeholder="رمز عبور"
                                x-ref="password"
